...
const Destacados = () =>{
    return(
        ...
        <div class=" w-full xl:h-[1200px]  " >
             ...
             <div className="w-full h-full grid  bg-gray-200   xl: grid grid-cols-2 gap-0">
                ...
                <div class="  flex flex-cols border-2 border-gray-500 bg-gray-200">
                    ...
                    <div class="  w-2/3  w-full h-[600px]">
                        ...
                        <div class="flex flex-cols mb-[50px] mt-[30px]">
                            ...
                            <div class=" w-3/4 h-5/6 flex flex-cols-2 justify-end shadow-2xl">
                                <figure class=" shrink-0  w-2/6 h-[198px]  mt-[15px] mr-[10px] border-gray-500 bg-gray-200 transform rotate-[-4deg] shadow-2xl">
                                     <img src={imagen1} alt="Descripción de la imagen" className=" w-full h-full transform rotate-[0deg] " />
                                </figure>

                                <figure class=" shrink-0  w-3/5 h-[200px]   mr-[10px] transform rotate-[-4deg] shadow-2xl">
                        ...
                        <div class="flex flex-cols ">
                            <div class=" w-1/4 h-[250px] mt-[40px] ml-[20px] bg-gray-200 shadow-2xl">
                                <figure class=" shrink-0  w-full h-full ">
                            ...
                            <div class=" w-3/4 h-[320px] mt-[-30px] ml-[30px] flex flex-cols-2 justify-end shadow-2xl ">
                    ...
                    <div class="flex w-1/5 h-6/6 justify-center items-center ml-[20px]  ">
                        <figure class=" w-full h-full bg-gray-200">
                          <img src={serpienteXul} alt="Descripción de la imagen" className="w-full h-full  transform rotate-[165deg] " />
                        </figure>
                    </div>
