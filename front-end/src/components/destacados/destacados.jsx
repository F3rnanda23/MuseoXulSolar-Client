...
const Destacados = () =>{
    return(
        <div>
            ...
            <div class="ml-[30px] mt-[10px] border-solid border-2 border-white-500">
                <div class="grid grid-cols-4 gap-4 grid-rows-auto mr-[30px] ml-[30px] mt-[20px] mb-[20px] " >
                    
                    <div>
                        <a href="https://www.xulsolar.org.ar/bibliografia.html" class="relative group">
                            <img src={bibliografia} alt="Descripción de la imagen" class="w-full h-[400px] object-cover transition-transform transform group-hover:scale-105" />
                    ...
                    <div>
                        <a href="https://www.xulsolar.org.ar/biografia.html" class="relative group">
                            <img src={biografiaXulSolar} alt="Descripción de la imagen" class="w-full h-60 object-cover transition-transform transform group-hover:scale-105"/>
                            <p class="absolute bottom-0 left-0 right-0 px-2 py-1 text-white bg-black bg-opacity-75 transition-opacity opacity-0 group-hover:opacity-100 text-center">BIBLIOGRAFÍA</p>
                        </a>
                    </div>
                    
                    <div>
                        <a href="https://www.xulsolar.org.ar/catalogo.html" class="relative group">
                            <img src={catalogoRazonado} alt="Descripción de la imagen"  class="w-full h-[150px] object-cover transition-transform transform group-hover:scale-105" />
                    ...
                    <div>
                        <a href="https://www.xulsolar.org.ar/coleccion.html" class="relative group">
                            <img src={coleccionPermanente} alt="Descripción de la imagen"   class="w-full h-[400px]  object-cover transition-transform transform group-hover:scale-105"/>
                    ...
                    <div>
                        <a href="https://www.xulsolar.org.ar/educacion.html" class="relative group">
                            <img src={educacion} alt="Descripción de la imagen"  class="w-full h-[280px] object-cover transition-transform transform group-hover:scale-105" />
                    ...
                    <div>
                        <a href="https://www.xulsolar.org.ar/museo.html" class="relative group">
                            <img src={elMuseo} alt="Descripción de la imagen"   class="w-full h-[400px] object-cover transition-transform transform group-hover:scale-105"/>
                    ...
                    <div>
                        <a href="https://www.xulsolar.org.ar/exposiciones.html" class="relative group">
                            <img src={exposiciones} alt="Descripción de la imagen"   class="w-full h-[500px] object-cover transition-transform transform group-hover:scale-105"/>
                    ...
                    <div>
                        <a href="https://www.xulsolar.org.ar/testimonios.html" class="relative group">
                            <img src={testimonio} alt="Descripción de la imagen"   class="w-full h-60 object-cover transition-transform transform group-hover:scale-105"/>
