                ...
                <div className=" w-full m-2">
                    ...
                    <input 
                        ...
                        {errors.name?.type==="minLength" && (
                            <span>*Ingrese al menos 2 caracteres</span>
                        )}
                        {errors.name?.type==="pattern" && (
                            <span>*ingrese solo letras del alfabeto</span>
                        )}
                </div>
                <div className="w-full m-2">
                    ...
                    <input 
                        ...
                        {errors.email?.type==="pattern" && (
                            <span>*Ingrese una direccion válida</span>)}
                </div>
                <div className="grid grid-cols-2 items-center gap-2 w-full m-2">
                    ...
                    <div className="flex flex-col">
                        ...
                        <input 
                            ...
                            <span>*Ingrese su número de celular</span>)}
                ...
                <div className="w-full m-2 relative ">
                    ...
                    <input className='w-full p-2 rounded '
                        ...
                        {errors.password?.type==="required" && (
                            <span>*Debe crear una contraseña</span>)}
                </div>
