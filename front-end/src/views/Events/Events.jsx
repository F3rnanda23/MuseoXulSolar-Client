  ...
  return (
    <div className="bg-gray-100 ">
      ...
      >
        ...
        <div className="w-3/5 flex flex-col items-center h-full w-3/5 flex flex-col items-center h-full bg-gray-200 p-6 rounded-lg shadow-lg">
          <p className="mt-4 text-lg text-gray-700">
            El museo ofrece sus instalaciones para distintas actividades: Entre
            ellas presentación de libros, música, ciclos de conferencias,
            cursos, entrega de premios, actos culturales y empresariales. El
            edificio, premiado en varias oportunidades, es un lugar ideal para
            organizar eventos, en un contexto privilegiado donde conviven la
            excelente colección de obras del Museo y el entorno especial de la
            arquitectura.
            <br></br>
            <br></br>
