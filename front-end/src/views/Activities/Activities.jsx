    ...
    return (
        ...
        <div className={style.activitiesContainer}>  
            ...
            <div class="grid sm:grid-cols-1 xl:grid-cols-2 ">
                ...
                <div class="grid  sm:order-2 sm:mt-[250px] sm:mr-[20px] xl:order-1 xl:mt-[50px] ">
                        ...
                        <div className=" grid grid-cols-1 gap-4  w-full h-full">  
                            ...
                            {activities && activities.map(activity => (
                                <div key={activity.name} className={style.contenedorCard}>
                                    <img src={activity.image} className="   w-2/5 h-4/5  object-cover transition-all duration-300 group-hover:opacity-90" />
                                    <div className="flex flex-col  justify-center gap-4 p-4 w-6/6 ml-[10px] mt-auto mb-auto  ">
                                        ...
                                        <div class="grid-cols-2 md:mt-[20px] lg:mt-[30px] xl:mt-[30px] xl:mb-[30px]"> 
                                            <div class=" lg:mt-[20px] xl:mt-[10px]">
                                                ...
                                                <button onClick={() => handleDelete(activity.id)} className="rounded  bg-orange-400 bg-opacity-50  px-3 py-1 text-gray-600 shadow-xl transition-all duration-300 hover:scale-105 2xl:px-5 py-2 ">Eliminar</button>
                                            </div>

                                            <div class=" lg:mt-[20px] xl:mt-[20px]">
                ...
                <div class="grid  sm:justify-center  sm:order-1 xl:order-2  xl:justify-end">
